...
describe('API Router', () => {
    ...
    test('should mount all sub-routers', async () => {
        const { default: appRouter } = await import('./app');
        const { default: containerRouter } = await import('./container');
        const { default: watcherRouter } = await import('./watcher');
        const { default: triggerRouter } = await import('./trigger');
        const { default: registryRouter } = await import('./registry');
        const { default: authenticationRouter } = await import('./authentication');
        const { default: logRouter } = await import('./log');
